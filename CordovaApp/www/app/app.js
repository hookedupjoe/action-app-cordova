    ...
    function setup(){
        try {
            ...
            */
            ...
            var tmpPluginComponents = ['SvgControls','WebControls', 'DataTables'];
            var tmpAppCompsToInit = ['WorkspacesPage', 'HomePage', 'QuickPage', 'DataTablesPage', 'DashboardPage', 'LogsPage','DebugPage']; 
